...
public class SondageListe extends ListActivity {
	...
	public static ArrayList<HashMap<String, String>> sondageList;
	...
	JSONObject json = jParser.getJSONFromUrl(url);
		...
		try {
			...
			sondageList= new ArrayList<HashMap<String, String>>();
...
//				listSondage.setAdapter(adapter);
				System.out.println("size of sondage list="+sondageList.size());
				...
				lv.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
						...
						Toast.makeText(SondageListe.this, " Sondage", 5000).show();
						// Starting new intent
						Intent in = new Intent(getParent(), SondageSingleItem.class);
	                ...
	                parentActivity.startChildActivity("inscription", in); 
