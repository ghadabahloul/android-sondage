...
public class RegisterActivity extends Activity  {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		View viewToLoad = LayoutInflater.from(this.getParent()).inflate(R.layout.inscription, null);
				...
				try {
					if (json.getString(KEY_SUCCESS) != null) {
						...
						if(Integer.parseInt(res) == 1){
			                ...
			                parentActivity.startChildActivity("inscription", main);
		...
		btnLinkToLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				Intent i = new Intent(getParent(),
						LoginActivity.class);
				TabGroupActivity parentActivity = (TabGroupActivity)getParent();
                parentActivity.startChildActivity("inscription", i); 
