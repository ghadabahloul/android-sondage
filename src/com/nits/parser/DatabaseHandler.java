...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	// Database Name
	private static final String DATABASE_NAME = "sondage_db";
	...
	public void UpdateUser( String name,String Date,String Sexe,String profession, String email, String uid) {
		SQLiteDatabase db = this.getWritableDatabase();
	...
	//	values.put(KEY_UPDATE_AT, update_at); // Created At
		...
		db.update(TABLE_LOGIN, values, KEY_ID + "=?" ,new String[]{String.valueOf(uid)});
	...
	public HashMap<String, String> getUserDetails(){
     ...
     //   Log.i("Readin user details",user.get("KEY_ID").toString());
        cursor.close();
        db.close();
		// return user
		return user;
